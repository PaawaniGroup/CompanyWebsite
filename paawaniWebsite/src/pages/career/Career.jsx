...
//               title="Build Your"
//               highlighted="Career"
//               description="Join a dynamic team that's transforming education and business through innovation, collaboration, and excellence. Discover opportunities to grow, learn, and make a meaningful impact."
...
//               Discover exciting opportunities to join our team and make a
//               meaningful impact in education and business innovation.
//             </p>
    ...
    <div className="min-h-screen bg-background pt-0">
      ...
      <section id="open-positions" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Conditional rendering for loading, error, and no jobs */}
          {loading && (
